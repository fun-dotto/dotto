  ...
  Future<void> search() async {
    ...
    if (state.senmonKyoyoStatus == 0) {
      ...
      if (isNotAllTrueOrAllFalse(gradeCheckList)) {
        ...
        final gradeName = <String>['一年次', '二年次', '三年次', '四年次'];
        ...
        final classificationName = <String>['100', '101'];
        if (gradeCheckList[0]) {
          // 1年
          // ['必修', '選択']
      ...
      if (isNotAllTrueOrAllFalse(educationCheckList)) {
        final educationNo = <String>['2', '1', '3', '4', '5'];
