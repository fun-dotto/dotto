...
abstract final class FunGridMaps {
  static final Map<String, List<MapTile>> mapTileListMap = {
    ...
    '2': [
      ...
      MapTile(2, 4, MapTileType.stair,
          ...
          right: 1,
          left: 1,
          stairType: const MapStairType(Axis.vertical,
              up: true, down: false)), // アトリエ側階段
    ...
    '3': [
      MapTile(12, 18, MapTileType.classroom,
          ...
          food: false,
          drink: true),
      MapTile(6, 6, MapTileType.subroom,
          top: 1, txt: 'トレーニングルーム', food: false, drink: true),
      ...
      MapTile(6, 12, MapTileType.classroom,
          txt: '工房', top: 1, food: false, drink: true, outlet: 2),
      MapTile(6, 12, MapTileType.classroom,
      ...
      MapTile(6, 4, MapTileType.subroom,
          txt: '映像音響スタジオ', food: false, drink: false),
      ...
      MapTile(2, 2, MapTileType.stair,
          ...
          right: 1,
          bottom: 1,
          stairType: const MapStairType(Axis.horizontal,
              up: true, down: false)), // 体育館側階段
      MapTile(2, 2, MapTileType.road),
      MapTile(6, 7, MapTileType.subroom,
          txt: 'ミュージアム', right: 1, food: false, drink: true),
      ...
      MapTile(3, 5, MapTileType.subroom,
          txt: '心理学実験室', food: false, drink: false),
      ...
      MapTile(2, 4, MapTileType.stair,
          ...
          right: 1,
          stairType: const MapStairType(Axis.vertical,
              up: false, down: true)), // 階段331側下り
      MapTile(2, 4, MapTileType.stair,
          bottom: 1,
          left: 1,
          right: 1,
          stairType: const MapStairType(Axis.vertical,
              up: false, down: true)), // 階段321側下り
      MapTile(18, 3, MapTileType.road, bottom: 1),
      MapTile(2, 2, MapTileType.road, bottom: 1),
      MapTile(2, 2, MapTileType.stair,
          top: 1,
    ...
    'R6': [
      ...
      MapTile(3, 3, MapTileType.subroom,
          top: 1, txt: 'R627', food: true, drink: true),
      MapTile(2, 30, MapTileType.road, top: 1, bottom: 1),
      MapTile(4, 4, MapTileType.subroom,
          top: 1, txt: 'R637', food: true, drink: true),
      ...
      MapTile(4, 2, MapTileType.stair,
          ...
          bottom: 1,
          stairType:
              const MapStairType(Axis.horizontal, up: true, down: false)),
      MapTile(4, 2, MapTileType.stair,
          right: 1,
          top: 1,
          bottom: 1,
    ...
    'R7': [
      MapTile(4, 2, MapTileType.subroom,
          txt: 'R711', top: 1, left: 1, food: true, drink: true),
      MapTile(1, 30, MapTileType.road, top: 1, bottom: 1),
      ...
      MapTile(4, 2, MapTileType.subroom,
          txt: 'R710', left: 1, food: true, drink: true),
      ...
      MapTile(4, 2, MapTileType.stair,
          ...
          bottom: 1,
          stairType:
              const MapStairType(Axis.horizontal, up: false, down: true)),
      MapTile(4, 2, MapTileType.stair,
          right: 1,
          top: 1,
          bottom: 1,
      ...
      MapTile(4, 2, MapTileType.subroom,
          txt: 'R754', right: 1, food: true, drink: true),
      MapTile(2, 4, MapTileType.subroom,
          txt: 'R724', left: 1, food: false, drink: true, outlet: 0),
      MapTile(4, 2, MapTileType.subroom,
          txt: 'R753', right: 1, food: true, drink: true),
      MapTile(4, 2, MapTileType.subroom,
          txt: 'R706', left: 1, food: true, drink: true),
      MapTile(2, 2, MapTileType.otherroom),
      MapTile(2, 2, MapTileType.otherroom),
      MapTile(9, 6, MapTileType.otherroom, right: 1),
      MapTile(4, 2, MapTileType.subroom,
          txt: 'R705', left: 1, food: true, drink: true),
      MapTile(2, 4, MapTileType.subroom,
          txt: 'R723', left: 1, bottom: 1, food: false, drink: true, outlet: 0),
      MapTile(4, 4, MapTileType.subroom, txt: 'R731', food: false, drink: true),
      MapTile(4, 2, MapTileType.subroom,
          txt: 'R704', left: 1, food: true, drink: true),
      MapTile(4, 2, MapTileType.stair,
          left: 1,
          top: 1,
          bottom: 1,
      ...
      MapTile(2, 2, MapTileType.road),
      MapTile(4, 2, MapTileType.subroom,
          txt: 'R703', left: 1, food: true, drink: true),
      MapTile(6, 1, MapTileType.road),
      ...
      MapTile(4, 2, MapTileType.subroom,
          txt: 'R702', left: 1, food: true, drink: true),
      ...
      MapTile(4, 2, MapTileType.subroom,
          txt: 'R701', left: 1, bottom: 1, food: true, drink: true),
  ...
  static final List<MapTile> mapCircle7To15TileList = [
    MapTile(1, 1, MapTileType.subroom,
        txt: 'サークル室15', food: true, drink: true, outlet: 2),
    MapTile(1, 1, MapTileType.subroom,
        txt: 'サークル室14', food: true, drink: true, outlet: 2),
    MapTile(1, 1, MapTileType.subroom,
        txt: 'サークル室13', food: true, drink: true, outlet: 2),
    MapTile(1, 1, MapTileType.subroom,
        txt: 'サークル室12', food: true, drink: true, outlet: 2),
    MapTile(1, 1, MapTileType.subroom,
        txt: 'サークル室11', food: true, drink: true, outlet: 2),
    MapTile(1, 1, MapTileType.subroom,
        txt: 'サークル室10', food: true, drink: true, outlet: 2),
    MapTile(1, 1, MapTileType.subroom,
        txt: 'サークル室9', food: true, drink: true, outlet: 2),
    MapTile(1, 1, MapTileType.subroom,
        txt: 'サークル室8', food: true, drink: true, outlet: 2),
    MapTile(1, 1, MapTileType.subroom,
        txt: 'サークル室7', food: true, drink: true, outlet: 2),
  ];
